    ...
    <main className="min-h-screen bg-[#0A0A0F]">
      ...
      <section className="pt-20 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div style={{ opacity: show ? 1 : 0, transform: show ? "none" : "translateY(30px)", transition: "all 0.7s ease" }}>
      ...
      <section className="px-6 mb-12">
        <div className="max-w-4xl mx-auto">
          <Link href="/fair-price" className="flex items-center justify-between bg-gradient-to-r from-[#FF6B6B]/10 to-[#FF6B6B]/5 border border-[#FF6B6B]/20 rounded-2xl p-6 hover:border-[#FF6B6B]/40 transition-all group">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[#6B6B8A] text-sm">Enter any price you paid — AI will tell you if it was fair</p>
              </div>
            </div>
            <span className="text-[#FF6B6B] font-bold text-xl group-hover:translate-x-2 transition-transform">→</span>
          </Link>
        </div>
      </section>
      ...
      <section className="px-6 mb-12">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-5">
            ...
            <span className="text-[#6B6B8A] text-sm">12 categories · AI fetches any product</span>
          </div>
          <CategoryGrid />
        </div>
      </section>
      ...
      <section className="px-6 mb-12">
        <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-4">
          {[
            ...
            { icon: <Brain className="w-5 h-5 text-[#6C63FF]" />, color: "#6C63FF", title: "ML Price Prediction", desc: "Python ML model predicts if price will rise or fall in next 7 days with 93% accuracy." },
      ...
      <section className="px-6 mb-16">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-5">
            ...
            <span className="text-[#6B6B8A] text-xs">Click for full analysis</span>
          </div>
      ...
      <footer className="border-t border-white/5 py-8 px-6">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div>
            <span className="font-bold text-white">Price<span className="text-[#6C63FF]">Pulse</span> India</span>
            <p className="text-[#6B6B8A] text-xs mt-1">Built with Next.js + Python ML + Gemini AI</p>
          </div>
