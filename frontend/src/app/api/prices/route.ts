...
const allProducts: Record<string, any[]> = {
  ...
  garlic: [{ name: "Garlic", price: "120", unit: "kg", change: 5, source: "Agmarknet", category: "Vegetable", description: "Fresh garlic from Madhya Pradesh mandis." }],
  ginger: [{ name: "Ginger", price: "80", unit: "kg", change: 2, source: "Agmarknet", category: "Vegetable", description: "Fresh ginger from Kerala and Karnataka." }],
  ...
  oneplus: [
    ...
    { name: "OnePlus Nord CE4", price: "24999", unit: "piece", change: -1, source: "Flipkart", category: "Smartphone", description: "OnePlus Nord CE4." },
  ...
  redmi: [
    ...
    { name: "Redmi 13C", price: "9999", unit: "piece", change: -1, source: "Amazon", category: "Smartphone", description: "Redmi 13C budget phone." },
    { name: "Redmi A3", price: "7499", unit: "piece", change: 0, source: "Flipkart", category: "Smartphone", description: "Redmi A3 entry level phone." },
  ],
  realme: [
    { name: "Realme 12 Pro+", price: "27999", unit: "piece", change: -4, source: "Flipkart", category: "Smartphone", description: "Realme 12 Pro+." },
    { name: "Realme Narzo 70", price: "14999", unit: "piece", change: -2, source: "Amazon", category: "Smartphone", description: "Realme Narzo 70 5G." },
    { name: "Realme C65", price: "9999", unit: "piece", change: -1, source: "Flipkart", category: "Smartphone", description: "Realme C65." },
  ],
  phone: [
    { name: "Redmi A3", price: "7499", unit: "piece", change: 0, source: "Flipkart", category: "Smartphone", description: "Redmi A3 entry level phone." },
    { name: "Redmi 13C", price: "9999", unit: "piece", change: -1, source: "Amazon", category: "Smartphone", description: "Redmi 13C." },
    { name: "Realme C65", price: "9999", unit: "piece", change: -1, source: "Flipkart", category: "Smartphone", description: "Realme C65." },
    { name: "Samsung Galaxy M14", price: "13999", unit: "piece", change: -1, source: "Amazon", category: "Smartphone", description: "Samsung Galaxy M14 5G." },
    { name: "Realme Narzo 70", price: "14999", unit: "piece", change: -2, source: "Amazon", category: "Smartphone", description: "Realme Narzo 70 5G." },
    { name: "Redmi Note 13", price: "17999", unit: "piece", change: -2, source: "Flipkart", category: "Smartphone", description: "Redmi Note 13 5G." },
    { name: "OnePlus Nord CE3 Lite", price: "17999", unit: "piece", change: -3, source: "Amazon", category: "Smartphone", description: "OnePlus Nord CE3 Lite." },
    { name: "Samsung Galaxy M34", price: "17999", unit: "piece", change: -2, source: "Flipkart", category: "Smartphone", description: "Samsung Galaxy M34 5G." },
    { name: "OnePlus Nord CE4", price: "24999", unit: "piece", change: -1, source: "Flipkart", category: "Smartphone", description: "OnePlus Nord CE4." },
    { name: "Samsung Galaxy A35", price: "26999", unit: "piece", change: -3, source: "Flipkart", category: "Smartphone", description: "Samsung Galaxy A35 5G." },
    { name: "Samsung Galaxy A55", price: "38999", unit: "piece", change: -2, source: "Amazon", category: "Smartphone", description: "Samsung Galaxy A55 5G." },
    { name: "iPhone 13", price: "44900", unit: "piece", change: -10, source: "Flipkart", category: "Smartphone", description: "Apple iPhone 13." },
    { name: "OnePlus 12", price: "64999", unit: "piece", change: -4, source: "Amazon", category: "Smartphone", description: "OnePlus 12." },
    { name: "Samsung Galaxy S24", price: "74999", unit: "piece", change: -5, source: "Flipkart", category: "Smartphone", description: "Samsung Galaxy S24." },
    { name: "iPhone 15", price: "79900", unit: "piece", change: -3, source: "Flipkart", category: "Smartphone", description: "Apple iPhone 15." },
    { name: "iPhone 15 Pro", price: "134900", unit: "piece", change: -2, source: "Flipkart", category: "Smartphone", description: "Apple iPhone 15 Pro." },
  ],
  macbook: [
  ...
  laptop: [
    { name: "Acer Aspire Lite", price: "29990", unit: "piece", change: -2, source: "Flipkart", category: "Laptop", description: "Acer Aspire Lite Ryzen 3." },
    { name: "HP 15s", price: "34990", unit: "piece", change: -1, source: "Amazon", category: "Laptop", description: "HP 15s Intel Core i3." },
    ...
    { name: "HP Pavilion 15", price: "54990", unit: "piece", change: -1, source: "Flipkart", category: "Laptop", description: "HP Pavilion 15 Ryzen 5." },
...
export async function GET(req: NextRequest) {
  ...
  if (prices.length === 0) {
    prices = [{ name: rawQuery, price: "N/A", unit: "unit", change: 0, source: "Not found", category: "Unknown", description: "No data available yet." }];
  }
